...
##################################################################
set bCheckSources 1
set list_bdc_active "IMU_interface"
...
0#Enet 0}\
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: IMU_interface, and set properties
  set IMU_interface [ create_bd_cell -type container -reference IMU_interface IMU_interface ]
  set_property -dict [ list \
   CONFIG.ACTIVE_SIM_BD {IMU_interface.bd} \
   CONFIG.ACTIVE_SYNTH_BD {IMU_interface.bd} \
   CONFIG.ENABLE_DFX {0} \
   CONFIG.LIST_SIM_BD {IMU_interface.bd} \
   CONFIG.LIST_SYNTH_BD {IMU_interface.bd} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins IMU_interface/BRAM_PORTA] [get_bd_intf_pins PS_interface/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports leds_4bits] [get_bd_intf_pins PS_interface/leds_4bits]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins PS_interface/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins PS_interface/FIXED_IO]

  # Create port connections
  connect_bd_net -net Control_FSM_0_LED_e [get_bd_ports LED_e] [get_bd_pins IMU_interface/LED_e]
  connect_bd_net -net Control_FSM_0_LED_s [get_bd_ports LED_s] [get_bd_pins IMU_interface/LED_s]
  connect_bd_net -net MISO_1 [get_bd_ports MISO] [get_bd_pins IMU_interface/MISO]
  connect_bd_net -net SPI_FSM_0_MOSI [get_bd_ports MOSI] [get_bd_pins IMU_interface/MOSI]
  connect_bd_net -net SPI_FSM_0_SCLK [get_bd_ports SCLK] [get_bd_pins IMU_interface/SCLK]
  connect_bd_net -net SPI_FSM_0_cs [get_bd_ports cs] [get_bd_pins IMU_interface/cs]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins IMU_interface/clk]
  connect_bd_net -net en_1 [get_bd_ports en] [get_bd_pins IMU_interface/en]
  connect_bd_net -net output_sel_0_dout [get_bd_ports BRAM_dout] [get_bd_pins IMU_interface/BRAM_dout]
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins IMU_interface/rst]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces PS_interface/processing_system7_0/Data] [get_bd_addr_segs PS_interface/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_interface/processing_system7_0/Data] [get_bd_addr_segs PS_interface/axi_gpio_0/S_AXI/Reg] -force
